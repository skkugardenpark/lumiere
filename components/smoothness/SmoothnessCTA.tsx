...
export default function SmoothnessCTA() {
  return (
        ...
        <div className="text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-light text-gray-800 mb-8 leading-tight">
              엄선된 장비를 사용하는<br />
              <span className="text-lumi-charcoal">피부과 전문의의</span><br />
              1:1 맞춤형 시술
            </h2>
            
            <p className="text-lg text-gray-600 mb-12 leading-relaxed">
              개인의 피부 상태에 맞는 정확한 진단과<br />
              체계적인 치료 계획으로 건강한 피부를 만들어드립니다.
            </p>
            ...
            >
              ...
              <div className="mt-8">
                ...
                <div className="text-gray-600 space-y-1">
                  <p>평일: 10:00 - 19:00</p>
                  <p>토요일: 10:00 - 14:00</p>
                  <p className="text-lumi-charcoal font-medium">일요일, 공휴일 휴진</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
